...
def var_vel(infile='particles/plummer_vel_3d_1e5_step0.bin', outfile='particles/plummer_vel_3d_1e5_step0_var.bin'):
    ...
    var_vel = particles[:, 4:7] * 0.9   # 速度 (vx, vy, vz) * 0.9 => 測試Jeans theorem
...
if __name__ == '__main__':
    ...
    # 執行一次積分步驟，時間步長為 0.1
    for i in range(100):
        infile=f"particles/plummer_vel_3d_1e5_step{i}_var.bin"
        outfile=f"particles/plummer_vel_3d_1e5_step{i+1}_var.bin"
