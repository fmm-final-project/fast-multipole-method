...
if __name__ == '__main__':
    ...
    for i in range(200):
        infile=f"particles_{method}/plummer_vel_3d_1e5_step{i}.bin"
        outfile=f"particles_{method}/plummer_vel_3d_1e5_step{i+1}.bin"
        run_KDK_step(dt=0.1, exe_name=exe_name, method=method, infile=infile, outfile=outfile)
        
    exe_name = "./tree_parallel"
    method = "tree" # fmm, tree, naive
    ...
    exe_name = "./naive_gravity_parallel"
    method = "naive" # fmm, tree, naive
